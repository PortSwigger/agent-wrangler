---
name: todo
description: Use when the user asks to turn the current session into a board TODO, including /todo.
---
...
2. Choose a short action-oriented title. Use a title supplied with `/todo` if there is one. Write a description from the conversation: what was learned, what remains, and the next useful step. Include concrete file paths or commands when they matter. Do not invent findings or copy the whole transcript.
