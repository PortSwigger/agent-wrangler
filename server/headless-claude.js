...
// jobs (archive-time memory review, other one-shot classification callers).
// Returns { text, liveSessionId, error }. `liveSessionId` is a fresh uuid rather
// than `--no-session-persistence` so the caller can push it onto a card's
