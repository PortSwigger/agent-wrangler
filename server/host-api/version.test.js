...
// 1.7.0 added the `view` slot's `badge` and 1.8.0 the client-side
// `openSession` (both public/slots.js), and a manifest declaring any of those
...
test('the served version is 1.8.0, and every 1.x manifest range it can honour passes', () => {
  assert.equal(HOST_API_VERSION, '1.8.0');
