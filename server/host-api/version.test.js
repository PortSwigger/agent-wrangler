...
// vocabulary and 1.6.0 added the `usage:read` and `sessions:bill` capabilities,
// and a manifest declaring any of those ranges is saying it needs that surface
// to exist. An additive change bumps the minor and keeps every ^1.0.0 manifest
// served by the same builders.
test('the served version is 1.6.0, and every 1.x manifest range it can honour passes', () => {
  assert.equal(HOST_API_VERSION, '1.6.0');
