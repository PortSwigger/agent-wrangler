...
export const spawnSessionTool = {
  ...
  inputSchema: {
    ...
    auto_compact_tokens: z.number().int().min(100000).max(1000000).optional().describe('Optional auto-compaction threshold / working context budget in tokens (100000–1000000). Immutable for the session and inherited by forks.'),
