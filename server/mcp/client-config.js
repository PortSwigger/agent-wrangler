...
// declared.
const ALLOWED_TOOLS = ['list_sessions', 'get_session_info', 'get_session_cost', 'list_tasks', 'list_todos', 'add_todo', 'edit_todo', 'delete_todo', 'move_todo', 'reorder_todos', 'spawn_session', 'get_links', 'set_links', 'workflow_phase', 'name_branch', 'send_message', 'archive_session', 'assign_session', 'rename_session', 'read_mail', 'list_mail', ...CHECKLIST_TOOLS];
