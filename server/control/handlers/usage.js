...
// from the process-wide memo in usage-scan-memo.js, shared with every other consumer
// of the scan so no two of them walk all of disk separately for the same numbers.
